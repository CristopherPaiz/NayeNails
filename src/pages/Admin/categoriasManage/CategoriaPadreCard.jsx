...
const CategoriaPadreCard = ({
  ...
  const handleSwitchClick = (e) => {
    e.stopPropagation(); // Detener el evento aquí
    onToggleActivo(); // Llamar a la función del padre que ahora prepara el modal
  };
  ...
  return (
    ...
    >
      {/* Chevron para expandir como background (solo móvil) */}
      ...
      >
        {/* Contenido principal del card (icono, nombre) */}
        <div className="flex items-start gap-2 sm:gap-3 w-full">
          ...
          {/* Botones de acción y switch para móvil (alineados a la derecha del título) */}
          <div className="flex items-center gap-2 flex-shrink-0 sm:hidden">
            ...
            <div onClick={handleSwitchClick} className="flex items-center">
              <CRSwitch
                ...
                onChange={() => {
                  /* El onChange ahora es manejado por handleSwitchClick */
                }}
                colorOff="bg-red-500"
              />
            </div>
        ...
        {/* Botones de acción y switch para desktop */}
      ...
      {/* Panel expandible con transición suave */}
      <div
      ...
      >
        <div className="p-3 sm:p-4 bg-slate-50 dark:bg-slate-800/50">
          {/* Botón para añadir subcategoría con mejor posicionamiento en móvil */}
