...
const Header = () => {
            ...
            >
              ...
              <div className="relative bg-background rounded-lg md:shadow-lg py-0">
                {value.categorías.map((sub) => {
                  ...
                  if (isAdminMenu) {
                    linkTo = sub.slug; // Para el menú de Admin, usamos el slug directamente como ruta
                  } else {
  ...
  // Función para renderizar los items de navegación en móvil
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-2 sm:py-2 sm:pl-8 flex items-center justify-between relative">
        ...
        <div className="hidden md:flex md:items-center">
          ...
          <nav className="flex flex-row items-center gap-x-2">
            ...
            {/* Menú de administración solo visible si el usuario está autenticado */}
        ...
        >
          ...
          {/* Menú de administración móvil solo visible si el usuario está autenticado */}
